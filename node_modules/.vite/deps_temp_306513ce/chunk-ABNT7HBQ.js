...
function D(t2, e, o = true) {
  var n, r, i2, l2;
  if (t2) {
    let d2 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w2(t2), s4 = d2.height, a2 = d2.width, u = e.offsetHeight, c2 = e.offsetWidth, f2 = e.getBoundingClientRect(), g3 = $2(), it = k2(), lt = h2(), L, N3, ot = "top";
...
function I(t2, e, o = true, n = void 0) {
  var r;
  if (t2) {
    let i2 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w2(t2), l2 = e.offsetHeight, d2 = e.getBoundingClientRect(), s4 = h2(), a2, u, c2 = n != null ? n : "top";
...
var w3 = (e = {}) => {
  ...
  return { preset(s4) {
    ...
    var o, c2;
    let { semantic: i2 } = t2 || {}, a2 = s4 && Object.hasOwn(s4, "light") ? s4.light : s4, n = s4 && Object.hasOwn(s4, "dark") ? s4.dark : s4, l2 = { colorScheme: { light: h3(h3({}, (o = i2 == null ? void 0 : i2.colorScheme) == null ? void 0 : o.light), !!a2 && { surface: a2 }), dark: h3(h3({}, (c2 = i2 == null ? void 0 : i2.colorScheme) == null ? void 0 : c2.dark), !!n && { surface: n }) } };
...
//# sourceMappingURL=chunk-ABNT7HBQ.js.map
