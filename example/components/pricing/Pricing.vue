<template>
    <div>
        ...
        <div class="px-0 lg:px-8 pricing-inner">
            <p class="mb-3 text-center text-lg">
                All licences share same terms and only differ in per-seat limits, visit the
                <a href="https://www.primefaces.org/blocks/licenses" class="text-blue-500 no-underline">license</a>
            ...
            <div class="flex flex-wrap">
                <div class="w-full lg:w-4 p-3">
                    <div class="shadow-2 p-4 surface-0 border-blue-500 border-2" style="border-radius: 6px">
                        ...
                        <div class="flex flex-wrap gap-3">
                            <span class="font-bold text-2xl text-900">$199</span>
                        </div>
                        <hr class="my-3 mx-0 border-top-1 border-none surface-border" />
                        <div class="pt-4 pb-0">
                            <ul class="list-none p-0 m-0">
                                ...
                                <li class="flex align-items-center mb-3">
                                    ...
                                    <span class="text-600 ml-2">Marketing Blocks</span>
                                </li>
                                <li class="flex align-items-center mb-3">
                                    <span class="border-circle bg-blue-500 text-white flex align-items-center justify-content-center flex-shrink-0" style="width: 1.5rem; height: 1.5rem">
                                        <i class="pi pi-check"></i>
                                    </span>
                                    <span class="text-600 ml-2">Application UI Blocks</span>
                                </li>
                                <li class="flex align-items-center mb-3">
                                    <span class="border-circle bg-blue-500 text-white flex align-items-center justify-content-center flex-shrink-0" style="width: 1.5rem; height: 1.5rem">
                                        <i class="pi pi-check"></i>
                                    </span>
                                    <span class="text-600 ml-2">E-Commerce Blocks</span>
                                </li>
                                <li class="flex align-items-center mb-3">
                                    <span class="border-circle bg-blue-500 text-white flex align-items-center justify-content-center flex-shrink-0" style="width: 1.5rem; height: 1.5rem">
                                        <i class="pi pi-check"></i>
                                    </span>
                                    <span class="text-600 ml-2">Figma File</span>
                                </li>
                                <li class="flex align-items-center mb-3">
                                    <span class="border-circle bg-blue-500 text-white flex align-items-center justify-content-center flex-shrink-0" style="width: 1.5rem; height: 1.5rem">
                                        <i class="pi pi-check"></i>
                            ...
                            <a href="https://www.primefaces.org/store/blocks.xhtml" class="border-round no-underline bg-blue-500 text-center hover:bg-blue-600 text-white block w-full p-3 mt-8 font-medium transition-colors transition-duration-150"
                                >Buy Now</a
                            >
                        </div>
                    </div>
                ...
                <div class="w-full lg:w-4 p-3">
                    <div class="shadow-2 p-4 surface-0 border-orange-500 border-2" style="border-radius: 6px">
                        ...
                        <hr class="my-3 mx-0 border-top-1 border-none surface-border" />
                        <div class="flex flex-wrap gap-3">
                            <span class="font-bold text-2xl text-900">$699</span>
                        </div>
                        <hr class="my-3 mx-0 border-top-1 border-none surface-border" />
                        <div class="pt-4 pb-0">
                            <ul class="list-none p-0 m-0">
                                <li class="flex align-items-center mb-3">
                                    ...
                                    <span class="font-bold text-700 ml-2">Up to 25 Developers</span>
                                </li>
                                <li class="flex align-items-center mb-3">
                                    <span class="border-circle bg-orange-500 text-white flex align-items-center justify-content-center flex-shrink-0" style="width: 1.5rem; height: 1.5rem">
                                        <i class="pi pi-check"></i>
                            ...
                            <a href="https://www.primefaces.org/store/blocks.xhtml" class="border-round no-underline bg-orange-500 text-center hover:bg-orange-600 text-white block w-full p-3 mt-8 font-medium transition-colors transition-duration-150"
                                >Buy Now</a
                            >
                        </div>
                    </div>
                ...
                <div class="w-full lg:w-4 p-3">
                    <div class="shadow-2 p-4 surface-0 border-bluegray-500 border-2" style="border-radius: 6px">
                        ...
                        <div class="pt-4 pb-0">
                            ...
                            <a href="mailto:contact@primetek.com.tr" class="border-round no-underline bg-bluegray-500 text-center hover:bg-bluegray-600 text-white block w-full p-3 mt-8 font-medium transition-colors transition-duration-150"
                                >Contact Us</a
                            >
                        </div>
                    </div>
        ...
        <div class="pricing-users bg-bluegray-700 text-center py-6 px-4 lg:px-8 pricing-inner">
            ...
            <p class="mt-0 p-0 mb-6 text-white line-height-3">
                The creator of PrimeVue is
                <a href="https://www.primetek.com.tr" class="text-white">PrimeTek Informatics</a>, the distinguished component library vendor who built vastly popular open source projects such as PrimeFaces, PrimeNG, PrimeReact and PrimeVue over the
                past years.
            </p>
            <div class="grid">
                <div class="col-6 md:col-2 p-3">
                    <img src="../../assets/images/pricing/airbus.svg" />
                </div>
                <div class="col-6 md:col-2 p-3">
                    <img src="../../assets/images/pricing/amex.svg" />
                </div>
                <div class="col-6 md:col-2 p-3">
                    <img src="../../assets/images/pricing/nvidia.svg" />
                </div>
                <div class="col-6 md:col-2 p-3">
                    <img src="../../assets/images/pricing/ebay.svg" />
                </div>
                <div class="col-6 md:col-2 p-3">
                    <img src="../../assets/images/pricing/ford.svg" />
                </div>
                <div class="col-6 md:col-2 p-3">
                    <img src="../../assets/images/pricing/fox.svg" />
                </div>
                <div class="col-6 md:col-2 p-3">
                    <img src="../../assets/images/pricing/lufthansa.svg" />
                </div>
                <div class="col-6 md:col-2 p-3">
                    <img src="../../assets/images/pricing/mercedes.svg" />
                </div>
                <div class="col-6 md:col-2 p-3">
                    <img src="../../assets/images/pricing/sap.svg" />
                </div>
                <div class="col-6 md:col-2 p-3">
                    <img src="../../assets/images/pricing/unicredit.svg" />
                </div>
                <div class="col-6 md:col-2 p-3">
                    <img src="../../assets/images/pricing/verizon.svg" />
                </div>
                <div class="col-6 md:col-2 p-3">
                    <img src="../../assets/images/pricing/viacom.svg" />
                </div>
            </div>
        </div>
        <div class="px-4 lg:px-8 pricing-inner">
            ...
            <div class="grid">
                <div class="col-12 lg:col-4 px-2 lg:px-5">
                    ...
                    <p class="mt-0 mb-6 p-0 line-height-3 text-700">
                        PrimeBlocks uses Figma as the design tool. It will be possible to download the Figma file after your purchase. You can
                        <a href="https://www.figma.com/file/TPzjHCPoKvur1ntpUhj98v/Preview-%7C-PrimeBlocks-%7C-3.2.0?node-id=3730%3A40223&t=XwUzfSmVjUFQ1I0r-1" class="text-blue-500 no-underline hover:underline">preview the Figma file</a>
                        before the purchase.
                    </p>
                </div>
                <div class="col-12 lg:col-4 px-2 lg:px-5">
                    ...
                    <p class="mt-0 mb-6 p-0 line-height-3 text-700">
                        ...
                        <a href="mailto:contact@primetek.com.tr" class="text-blue-500 no-underline hover:underline">contact us</a>
                ...
                <div class="col-12 lg:col-4 px-2 lg:px-5">
                    ...
                    <p class="mt-0 mb-6 p-0 line-height-3 text-700">
                        ...
                        <a href="https://forum.primefaces.org/viewforum.php?f=152" class="text-blue-500 no-underline hover:underline">a dedicated forum channel monitored</a>
