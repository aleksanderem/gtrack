<template>
    <div>
        ...
        <BlockViewer header="Single Picture with Selectors" :code="block1" :previewStyle="{ height: '640px' }" containerClass="flex align-items-center justify-content-center">
            <div class="shadow-2 border-round surface-card p-4" @mouseenter="hovered = true" @mouseleave="hovered = false">
                <div class="relative">
                    ...
                    <button
                        v-if="hovered"
                        class="fadein absolute p-component border-none bg-black-alpha-40 hover:bg-black-alpha-50 px-3 py-2 text-white font-medium text-base border-round cursor-pointer transition-colors transition-duration-300 w-13rem"
                ...
                <div class="grid relative">
                    ...
                    <div class="col-12 lg:col-6 py-0 lg:pl-5">
                        ...
                        <div class="flex align-items-center mb-5">
                            <div
                                class="w-2rem h-2rem flex-shrink-0 border-circle bg-cyan-500 mr-3 cursor-pointer border-2 border-white transition-all transition-duration-300"
                                :style="{
                            ...
                            ></div>
                            <div
                                class="w-2rem h-2rem flex-shrink-0 border-circle bg-purple-500 mr-3 cursor-pointer border-2 border-white transition-all transition-duration-300"
                                :style="{
                            ...
                            ></div>
                            <div
                                class="w-2rem h-2rem flex-shrink-0 border-circle bg-indigo-500 cursor-pointer border-2 border-white transition-all transition-duration-300"
                                :style="{
                        ...
                        <div class="flex align-items-center mb-3 text-base">
                            <div
                                class="h-2rem w-2rem border-1 border-300 text-900 inline-flex justify-content-center align-items-center flex-shrink-0 border-round mr-2 cursor-pointer hover:surface-100 transition-duration-150 transition-colors"
                                :class="{
        ...
        <BlockViewer header="Galleria and Features" :code="block2" :previewStyle="{ backgroundColor: 'var(--maskbg)' }" containerClass="flex align-items-center justify-content-center h-screen">
            <div class="surface-overlay border-round p-4 shadow-4 relative" style="max-width: 800px">
                <div class="grid">
                    ...
                    <div class="col-12 md:col-6 md:pl-5">
                        <div class="flex justify-content-end">
                            <Button class="p-button-text p-button-plain p-button-rounded absolute md:sticky" icon="pi pi-times pi-2xl" style="right: 0.5rem; top: 0.5rem"></Button>
                        </div>
...
export default {
    data() {
        return {
            ...
            color1: 'cyan',
            size1: 'M',
            images: ['product-quickview-2-1.png', 'product-quickview-2-2.png', 'product-quickview-2-3.png', 'product-quickview-2-4.png', 'product-quickview-2-5.png', 'product-quickview-2-6.png'],
            responsiveOptions: [
                {
                    breakpoint: '768px',
                    numVisible: 3
