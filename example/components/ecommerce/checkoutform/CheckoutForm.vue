                ...
                <div class="grid -mr-3 -ml-3">
                    <div class="col-12 lg:col-8 p-4">
                        <div class="surface-card grid formgrid p-fluid border-round shadow-2 p-4">
                            ...
                            <Divider class="w-full px-2 mb-3"></Divider>
                            ...
                            <div class="col-12 flex flex-column lg:flex-row field">
                                <div
                                    ...
                                    @click="selectedValue = 'UPS'"
                                    :class="{
                                        'border-primary surface-50': selectedValue === 'UPS'
                                    }"
                                >
                            ...
                            <div class="col-12 mb-4">
                                <div
                                    ...
                                    @click="selectedValue2 === 'paypal'"
                                    :class="{
                                        'border-primary surface-50': selectedValue2 === 'paypal'
                                    }"
                                >
                                ...
                                <div
                                    ...
                                    @click="selectedValue2 === 'creditcard'"
                                    :class="{
                                        'border-primary surface-50': selectedValue2 === 'creditcard'
                                    }"
                                >
                                ...
                                <div
                                    ...
                                    @click="selectedValue2 === 'bank'"
                                    :class="{
                                        'border-primary surface-50': selectedValue2 === 'bank'
                                    }"
                                >
                            ...
                            <div class="col-12 field mb-4">
                                <form ref="form1" class="relative">
                                    ...
                                    <InputMask mask="9999-9999-9999-9999" v-model="cc" placeholder="9999-9999-9999-9999" style="margin-right: 0.5em" />
                            ...
                            <div class="col-12 lg:col-6 field mb-4">
                                <form ref="form2" class="relative">
                                    ...
                                    <InputMask mask="99/99" v-model="exp" placeholder="99/99" slotChar="MM/YY" style="margin-right: 0.5em" />
                            ...
                            <div class="col-12 lg:col-6 field mb-4">
                                <form ref="form3" class="relative">
                                    ...
                                    <InputMask mask="999" v-model="cvc" placeholder="999" style="margin-right: 0.5em" />
                                    ...
                                    <div class="grid flex-column lg:flex-row">
                                        <div class="col p-3">
                                            <div
                                                ...
                                                :class="{
                                                    'border-primary': selectedAddress === address1
                                                }"
                                            >
                                        ...
                                        <div class="col p-3">
                                            <div
                                                ...
                                                :class="{
                                                    'border-primary': selectedAddress === address2
                                                }"
                                            >
                                                <div class="flex justify-content-between mb-3">
