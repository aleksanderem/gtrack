<template>
    <div>
        ...
        <BlockViewer header="2x3 Grid" :code="block1">
                            ...
                            <div class="p-2">
                                <div class="border-1 surface-border border-round p-3">
                                    ...
                                    <p class="m-0 p-0 line-height-3 text-600">
                                        Etiam tempor orci eu lobortis elementum nibh tellus. Auctor eu augue ut lectus arcu bibendum at varius vel. Id aliquet lectus proin nibh nisl. Lorem ipsum dolor sit amet consectetur.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <BlockViewer header="Single Column" :code="block2">
            <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
                <div class="grid">
        ...
        <BlockViewer header="With Seller Comment" :code="block3">
            <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
                    ...
                    <li class="border-top-1 surface-border py-5">
                        ...
                        <div class="mt-5 flex flex-column sm:flex-row align-items-start sm:align-items-center">
                            ...
                            <div class="border-200 border-1 border-round p-3 surface-50 flex-auto">
                                ...
                                <p class="text-600 line-height-3 mt-3 mb-0 p-0">Quis varius quam quisque id diam vel quam elementum pulvinar. Suspendisse interdum consectetur libero id faucibus nisl tincidunt eget. Sit amet mauris commodo quis.</p>
                            </div>
                        </div>
                    </li>
                    <li class="border-top-1 surface-border py-5">
                        ...
                        <div class="mt-5 flex flex-column sm:flex-row align-items-start sm:align-items-center">
                            ...
                            <div class="border-200 border-1 border-round p-3 surface-50 flex-auto">
                                <span class="text-900 font-medium">Peak Representative</span>
                                <p class="text-600 line-height-3 mt-3 mb-0 p-0">
                                    Risus commodo viverra maecenas accumsan lacus vel facilisis volutpat. Amet nulla facilisi morbi tempus iaculis. Imperdiet massa tincidunt nunc pulvinar sapien et ligula ullamcorper malesuada.
                                </p>
                            </div>
                        </div>
                    </li>
        ...
        <BlockViewer header="With Image" :code="block4">
