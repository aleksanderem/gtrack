<template>
    <div>
        <div class="block-category-title">Testimonials</div>
                ...
                <div class="flex flex-column md:flex-row">
                    <div class="flex flex-grow-1 mb-4 md:mb-0 md:px-4 py-4 md:py-0">
                        <div class="shadow-2 surface-card border-round relative">
                            <img src="/images/blocks/testimonial/testimonials-1.png" width="100" height="100" class="absolute left-50" style="margin-left: -50px; top: -50px" />

                            <div class="px-4 pb-4 pt-8 relative">
                                <p class="text-900 font-italic line-height-3 text-lg m-0 pb-4 border-bottom-1 surface-border">“Lorem ipsum dolor sit amet, sed tempor incididunt ut labore et dolore magna alique.”</p>
                    ...
                    <div class="flex flex-grow-1 mb-4 md:mb-0 md:px-4 py-4 md:py-0">
                        <div class="shadow-2 surface-card border-round relative">
                            <img src="/images/blocks/testimonial/testimonials-2.png" width="100" height="100" class="absolute left-50" style="margin-left: -50px; top: -50px" />
                    ...
                    <div class="flex flex-grow-1 md:px-4 py-4 md:py-0">
                        <div class="shadow-2 surface-card border-round relative">
                            <img src="/images/blocks/testimonial/testimonials-3.png" width="100" height="100" class="absolute left-50" style="margin-left: -50px; top: -50px" />
                ...
                <Carousel :value="company">
                    <template #item="slotProps">
                        <div class="flex justify-content-center">
                            <div class="surface-card shadow-2 px-2 md:px-6 py-5 border-round mb-4 text-900 text-2xl line-highlight-3" style="max-width: 600px">
                                {{ slotProps.data.text }}
                            </div>
                        </div>

                        <img :src="'/images/blocks/testimonial/testimonials-' + slotProps.data.image + '.png'" width="56" height="56" :alt="slotProps.data.name" class="mb-3" />
                ...
                <div class="grid grid-nogutter">
                    <div class="col-12 lg:col-6 xl:col-4 p-4">
                        <div class="surface-card shadow-2 p-4 flex flex-column align-items-center md:flex-row md:align-items-stretch h-full" style="border-radius: 10px">
                            <span>
                                <img src="/images/blocks/avatars/circle/avatar-f-1.png" class="w-5rem" />
                            </span>
                    ...
                    <div class="col-12 lg:col-6 xl:col-4 p-4">
                        <div class="surface-card shadow-2 p-4 flex flex-column align-items-center md:flex-row md:align-items-stretch h-full" style="border-radius: 10px">
                            <span>
                                <img src="/images/blocks/avatars/circle/avatar-m-1.png" class="w-5rem" />
                            </span>
                            <div class="flex flex-column align-items-center md:align-items-stretch ml-4 mt-4 md:mt-0">
                    ...
                    <div class="col-12 lg:col-6 xl:col-4 p-4">
                        <div class="surface-card shadow-2 p-4 flex flex-column align-items-center md:flex-row md:align-items-stretch h-full" style="border-radius: 10px">
                            <span>
                                <img src="/images/blocks/avatars/circle/avatar-f-2.png" class="w-5rem" />
                            </span>
                            <div class="flex flex-column align-items-center md:align-items-stretch ml-4 mt-4 md:mt-0">
                    ...
                    <div class="col-12 lg:col-6 xl:col-4 p-4">
                        <div class="surface-card shadow-2 p-4 flex flex-column align-items-center md:flex-row md:align-items-stretch h-full" style="border-radius: 10px">
                            <span>
                                <img src="/images/blocks/avatars/circle/avatar-f-3.png" class="w-5rem" />
                            </span>
                            <div class="flex flex-column align-items-center md:align-items-stretch ml-4 mt-4 md:mt-0">
                    ...
                    <div class="col-12 lg:col-6 xl:col-4 p-4">
                        <div class="surface-card shadow-2 p-4 flex flex-column align-items-center md:flex-row md:align-items-stretch h-full" style="border-radius: 10px">
                            <span>
                                <img src="/images/blocks/avatars/circle/avatar-f-4.png" class="w-5rem" />
                            </span>
                            <div class="flex flex-column align-items-center md:align-items-stretch ml-4 mt-4 md:mt-0">
                    ...
                    <div class="col-12 lg:col-6 xl:col-4 p-4">
                        <div class="surface-card shadow-2 p-4 flex flex-column align-items-center md:flex-row md:align-items-stretch h-full" style="border-radius: 10px">
                            <span>
                                <img src="/images/blocks/avatars/circle/avatar-m-5.png" class="w-5rem" />
                            </span>
                            <div class="flex flex-column align-items-center md:align-items-stretch ml-4 mt-4 md:mt-0">
        ...
        <BlockViewer header="3x1 Grid with Offset Images" :code="block4">
            <div style="background: url('/images/blocks/testimonial/testimonials-4.png') no-repeat; background-size: cover" class="px-4 py-8 md:px-6 lg:px-8">
                <div class="flex flex-column lg:flex-row">
                    <div class="flex-1 pr-0 lg:pr-6 pb-6 lg:pb-0">
                        ...
                        <p class="line-height-3 text-600 text-xl mb-5">
                            Egestas tellus rutrum tellus pellentesque eu tincidunt tortor aliquam. Viverra vitae congue eu consequat ac felis. Magna eget est lorem ipsum dolor sit. Bibendum enim facilisis gravida neque convallis a cras semper auctor.
                            Porttitor massa id neque aliquam vestibulum morbi. Purus non enim praesent elementum facilisis leo vel fringilla est. Donec massa sapien faucibus et molestie ac feugiat.
                        </p>
                        <Button label="Learn More" class="text-xl"></Button>
                    </div>
                    <div class="flex-1">
        ...
        <BlockViewer header="Background Image" :code="block5">
            <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
                <div class="bg-no-repeat bg-cover bg-center border-round-xl p-7" style="background: url('/images/blocks/testimonial/testimonials-5.jpg')">
                    <img src="/images/blocks/logos/franki-300.svg" alt="Image" class="block mb-4" />
                    <div>
        ...
        <BlockViewer header="Side-by-Side" :code="block6" recent>
            <section class="flex flex-column lg:flex-row justify-content-between align-items-center surface-section">
                <article class="flex flex-column w-full gap-5 px-4 py-8 md:px-6 lg:px-8">
                    ...
                    <div class="flex align-items-center gap-3">
                        <Button label="Try it free" class="p-button-outlined"></Button>
                        <Button label="Upgrade now" icon="pi pi-bolt" iconPos="right"></Button>
                    </div>
                </article>
                <article class="w-full bg-cover flex align-items-end p-5 bg-center" style="background: url('/images/blocks/testimonial/testimonials-8.jpg'); height: 44rem">
                    <div class="flex flex-column gap-5 border-round-lg p-3 w-full" style="backdrop-filter: blur(12.25px); background: rgba(255, 255, 255, 0.15); border: 1px solid rgba(255, 255, 255, 0.15)">
                        ...
                        <div class="flex justify-content-between">
                            ...
                            <div class="flex align-items-center gap-2">
                                <Button icon="pi pi-arrow-left" style="border: 1px solid rgba(255, 255, 255, 0.15)" class="p-button-rounded bg-white-alpha-10 text-white"></Button>
                                <Button icon="pi pi-arrow-right" style="border: 1px solid rgba(255, 255, 255, 0.15)" class="p-button-rounded bg-white-alpha-10 text-white"></Button>
                            </div>
                        </div>
                    </div>
                </article>
        ...
        <BlockViewer header="Centered With Logo" :code="block7" recent>
            <section class="surface-ground text-center px-0 sm:px-4 py-8 md:px-6 lg:px-8">
                <div class="flex justify-content-center text-center mb-4 gap-2">
                    <img src="/images/blocks/logos/hodly-indigo-500.svg" height="38" />
                </div>
                <div class="flex justify-content-center">
                    <h2 class="px-2 md:px-6 text-900 text-5xl font-medium line-height-3 mb-0" style="max-width: 1350px">
                ...
                <img src="/images/blocks/testimonial/testimonials-3.png" width="56" height="56" class="mt-4" />
        ...
        <template #item="slotProps">
            <div class="flex justify-content-center">
                <div class="surface-card shadow-2 px-2 md:px-6 py-5 border-round mb-4 text-900 text-2xl line-highlight-3"
                    style="max-width: 600px">{{slotProps.data.text}}</div>
            </div>

            <img :src="'/images/blocks/testimonial/testimonials-' + slotProps.data.image + '.png'" width="56" height="56" :alt="slotProps.data.name" class="mb-3" />
            <div class="text-900 font-bold line-height-3">{{slotProps.data.name}}</div>
            <div class="text-600 line-height-3 mb-4">Company Title</div>
        </template>
    </Carousel>
</div>`,
...
<div class="surface-section px-4 py-8 md:px-6 lg:px-8">
    <div class="bg-no-repeat bg-cover bg-center border-round-xl p-7" style="background: url('/images/blocks/testimonial/testimonials-5.jpg')">
        <img src="/images/blocks/logos/franki-300.svg" alt="Image" class="block mb-4" />
        <div>
            <p class="text-white text-4xl mt-0 mb-3 line-height-3">"Very easy to use. I made back the purchase price in just 48 hours! It's greaIt's is both attractive and highly adaptable."</p>
            <div class="text-white text-xl font-medium mb-3">Esther Howard</div>
            <div class="text-primary font-semibold">Marketing Coordinator</div>
        </div>
    </div>
...
<section class="flex flex-column lg:flex-row justify-content-between align-items-center surface-section">
    ...
    <article class="w-full bg-cover flex align-items-end p-5 bg-center" style="background:url('/images/blocestimonial/testimonials-8.jpg'); height:44rem">
        <div class="flex flex-column gap-5 border-round-lg p-3 w-full" style="backdrop-filter: blur(12.25packground: rgba(255, 255, 255, 0.15); border: 1px solid rgba(255, 255, 255, 0.15);">
            <p class="m-0 text-0 text-2xl line-height-3 font-semibold text-center text-white">“He wondered t could be called a beach if there was no sand.”</p>
            <div class="flex gap-3 align-items-center">
                <hr class="w-full" style="border: 1px solid rgba(222, 226, 230, 0.15);">
                <div class="flex align-items-center gap-2">
                    <i class="pi pi-star-fill text-white"></i>
            ...
            <div class="flex justify-content-between">
                <div class="flex flex-column gap-1">
                    <p class="mt-0 mb-0 font-semibold line-height-3 text-base text-white">Johnathan Doe</p>
                    <span class="text-50 font-light line-height-3 text-sm text-white-alpha-80">CEOo-Founder of Hyper</span>
                </div>
                <div class="flex align-items-center gap-2">
                    <Button icon="pi pi-arrow-left" style="border: 1px solid rgba(255, 255, 255,5);" class="p-button-rounded bg-white-alpha-10 text-white"></Button>
                    <Button icon="pi pi-arrow-right" style="border: 1px solid rgba(255, 255, 255,5);" class="p-button-rounded bg-white-alpha-10 text-white"></Button>
                </div>
            </div>
        </div>
    </article>
...
<section class="surface-ground text-center px-0 sm:px-4 py-8 md:px-6 lg:px-8">
    ...
    <div class="flex justify-content-center">
        <h2 class="px-2 md:px-6 text-900 text-5xl font-medium line-height-3 mb-0" style="max-width: 1350px">It is a fantastic component library for web development. The components are easy to use, well-designed, and the documentation and support are top-notch. Highly recommend!”</h2>
    </div>
    <img src="/images/blocks/testimonial/testimonials-3.png" width="56" height="56" class="mt-4" />
    <p class="text-900 font-semibold text-xl line-height-3 text-center">Annie Lanphear</p>
    <p class="text-600 font-normal line-height-1 mt-2 text-md text-center">Software Engineer</p>
