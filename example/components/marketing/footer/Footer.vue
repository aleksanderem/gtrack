            ...
            <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
                <div class="border-top-1 border-300 pt-5 text-center">
                    ...
                    <ul class="list-none p-0 mx-0 my-5 flex justify-content-center flex-column align-items-center lg:flex-row">
                        <li>
                            <a class="text-600 cursor-pointer line-height-3 lg:mr-5">About Us</a>
                        </li>
                        <li>
                            <a class="text-600 cursor-pointer line-height-3 lg:mr-5">News</a>
                        </li>
                        <li>
                            <a class="text-600 cursor-pointer line-height-3 lg:mr-5">Investor Relations</a>
                        </li>
                        <li>
                            <a class="text-600 cursor-pointer line-height-3 lg:mr-5">Careers</a>
                        </li>
                        <li>
                            <a class="text-600 cursor-pointer line-height-3">Media Kit</a>
                        </li>
                    </ul>
                    ...
                    <div class="grid">
                        ...
                        <div class="col-12 sm:col-6 md:col-4 lg:col-2">
                            ...
                            <ul class="list-none p-0 m-0">
                                ...
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Privacy Policy</a>
                                </li>
                                <li class="mb-2">
