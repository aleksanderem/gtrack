<template>
    <div>
        <div class="block-category-title">Landing</div>
        <BlockViewer header="Landing Page I" :code="block1">
            ...
            <div class="surface-section px-4 pb-8 md:px-6 lg:px-8">
                <div
                    class="p-6 shadow-2 flex flex-column md:flex-row align-items-center justify-content-between"
            ...
            <div class="surface-ground px-4 py-8 md:px-6 lg:px-8">
                <div>
                    ...
                    <p class="text-600 line-height-3 text-lg m-0 mb-6 text-center">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
            ...
            <div class="surface-ground">
                <div class="grid grid-nogutter">
                    <div class="col-12 md:col-6 bg-no-repeat bg-cover p-8" style="background-image: url('/images/blocks/contact/contact-2.jpg')">
                    ...
                    <div class="col-12 md:col-6">
                        <div class="p-fluid formgrid grid px-4 py-8 md:px-6 lg:px-8">
                            ...
                            <div class="field col-12 mb-4">
                                <Textarea id="message" :rows="3" :autoResize="true" class="py-3 px-2 text-lg" placeholder="Message"></Textarea>
                            </div>
        ...
        <BlockViewer header="Landing Page II" :code="block2">
            <div class="bg-gray-900 py-3 px-6 shadow-2 flex align-items-center justify-content-between relative">
                ...
                <a
                    class="cursor-pointer block lg:hidden text-gray-400"
                    v-styleclass="{
                        selector: '@next',
                        enterClass: 'hidden',
                        leaveToClass: 'hidden',
            ...
            <div class="surface-ground px-4 py-8 md:px-6 lg:px-8">
                <div class="flex flex-wrap relative overflow-hidden" style="border-radius: 1rem; background: radial-gradient(100% 1126.49% at 100% 0%, rgba(106, 200, 212, 0.4) 0%, rgba(33, 33, 33, 0) 100%), #212121">
                    <div class="px-6 py-8">
                        ...
                        <button v-ripple class="appearance-none p-3 bg-cyan-500 hover:bg-cyan-300 cursor-pointer font-medium gray-900 border-none p-component transition-colors transition-duration-150 p-ripple" style="border-radius: 35px">
                    ...
                    <table class="w-full white-space-nowrap" style="border-collapse: collapse; border-spacing: 0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center p-medium border-bottom-1 border-200">
                            ...
                            <tr>
                                ...
                                <td class="text-center p-medium border-bottom-1 border-200">
                                    <i class="text-500 pi pi-times"></i>
                                </td>
                                <td class="text-center p-medium border-bottom-1 border-200">
                                    <i class="text-green-500 pi pi-check"></i>
                                </td>
                ...
                <div class="py-5 border-bottom-1 border-300">
                    <div class="grid">
                        <div class="col-12 sm:col-6 md:col-4 lg:col-2">
                            ...
                            <ul class="list-none p-0 m-0">
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">About Us</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">News</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Investor Relations</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Careers</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Media Kit</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-12 sm:col-6 md:col-4 lg:col-2">
                            ...
                            <ul class="list-none p-0 m-0">
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Get Started</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Learn</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Case Studies</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-12 sm:col-6 md:col-4 lg:col-2">
                            ...
                            <ul class="list-none p-0 m-0">
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Courses</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Documentation</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">API Reference</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Status</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Papers</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Development Blog</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-12 sm:col-6 md:col-4 lg:col-2">
                            ...
                            <ul class="list-none p-0 m-0">
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Discord</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Events</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">FAQ</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Blog</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-12 sm:col-6 md:col-4 lg:col-2">
                            ...
                            <ul class="list-none p-0 m-0">
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Newsletters</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Press</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Code of Conduct</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Security Guide</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Bug Bounty</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-12 sm:col-6 md:col-4 lg:col-2">
                            ...
                            <ul class="list-none p-0 m-0">
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Brand Policy</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Privacty Policy</a>
                                </li>
                                <li class="mb-2">
                                    <a class="text-700 cursor-pointer line-height-3">Terms of Service</a>
                                </li>
                            </ul>
                        </div>
                    </div>
