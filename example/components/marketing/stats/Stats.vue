    ...
    <div>
        ...
        <BlockViewer header="Simple 4x1 Grid" :code="block1">
            <div class="surface-ground px-4 py-8 md:px-6 lg:px-8">
                ...
                <p class="text-600 line-height-3 text-lg m-0 mb-5">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
        ...
        <BlockViewer header="Centered with Dark Background" :code="block3">
            <div class="bg-gray-900 text-center bg-gray-900 px-4 py-8 md:px-6 lg:px-8">
                ...
                <p class="text-gray-500 line-height-3 text-lg m-0 mb-4">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Consequat semper viverra nam libero justo laoreet sit. Purus sit amet volutpat consequat.
                </p>
            ...
            <div class="bg-gray-900 px-4 py-8 md:px-6 lg:px-8">
                <div class="flex flex-column lg:flex-row">
                    <div class="flex-1 pr-0 lg:pr-5 mb-5 lg:mb-0">
                        ...
                        <p class="text-gray-600 font-medium text-xl mt-0 mb-7 line-height-3">
                            Porta lorem mollis aliquam ut porttitor leo a diam. Amet purus gravida quis blandit. Consectetur libero id faucibus nisl tincidunt. Aenean vel elit scelerisque mauris pellentesque pulvinar pellentesque habitant morbi. Sit
                            amet risus nullam eget felis eget. Feugiat pretium nibh ipsum consequat nisl vel pretium.
                        </p>
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <div class="w-full lg:w-6 p-3">
                                <div class="p-3 bg-indigo-500 border-round" style="min-height: 150px">
                                    ...
                                    <Button label="Learn More" icon="pi pi-arrow-right" class="block mt-5 p-button-warning white-space-nowrap"></Button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <BlockViewer header="Image Background" :code="block6" recent>
            <section class="relative surface-section">
                ...
                <div class="px-4 py-5 md:px-6 lg:px-8">
                    <div class="flex flex-column lg:flex-row lg:align-items-center lg:justify-content-between">
                        <div class="px-2 w-full py-6 md:px-4 lg:px-6 bg-cover relative border-round" style="background: url(/images/blocks/stats/stats-1.png); background-position: center; margin-top: -2rem; top: -70px">
                            <div class="flex flex-column lg:flex-row">
