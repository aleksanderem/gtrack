<template>
    <div>
        <div class="block-category-title">Hero</div>
        <BlockViewer header="Right Aligned Image" :code="block1" :free="true">
        ...
        <BlockViewer header="Dark Image Background" :code="block3">
            <div class="relative p-8 overflow-hidden bg-no-repeat bg-cover" style="background-image: url('/images/blocks/hero/hero-3.jpg')">
                <div class="text-center my-6 relative">
                    ...
                    <div class="flex align-items-center justify-content-center flex-wrap">
                        <InputText type="text" class="bg-transparent border-white p-3 mr-3 mt-3" style="border-radius: 40px" size="30" placeholder="Enter your email" />
                        <Button label="Notify Me" class="p-3 mt-3" style="border-radius: 40px"></Button>
                    </div>
                </div>
            </div>
        </BlockViewer>
        ...
        <BlockViewer header="Centered Product Image" :code="block4">
            <div class="p-6 text-center" style="background: radial-gradient(69.84% 69.84% at 50% 100%, rgba(21, 101, 192, 0.15) 0%, rgba(255, 255, 255, 0) 100%)">
                ...
                <Button type="button" label="Get Started" class="p-button-outlined p-3 font-bold"></Button>

                <img src="/images/blocks/hero/ultima.png" alt="Image" class="block mx-auto mt-6 w-full md:w-auto" style="margin-bottom: -3rem" />
            </div>
        </BlockViewer>
                ...
                <div class="flex flex-wrap">
                    <div class="w-12 lg:w-6 p-4">
                        <h1 class="text-6xl font-bold text-white mt-0 mb-3">
                            ...
                            <span class="text-yellow-500 underline">for free</span>
                        </h1>
                        ...
                        <Button label="Claim Your Account" class="block mt-7 mb-7 lg:mb-0 p-button-rounded p-button-success p-button-lg font-medium"></Button>
                    </div>
                ...
                <div class="flex flex-wrap">
                    <div class="w-full xl:w-6 p-3 pr-5">
                        ...
                        <div class="relative w-full xl:w-30rem">
                            <InputText type="text" placeholder="Enter your email" class="py-3 pl-3 w-full" style="border-radius: 30px; padding-right: 8rem" />
                            <button class="p-3 absolute appearance-none p-component border-none bg-indigo-500 hover:bg-indigo-600 active:bg-indigo-700 text-white outline-none h-full cursor-pointer" style="border-radius: 30px; top: 0; right: 0">
                                Join Now
                            </button>
                        </div>
                    </div>
                    <div class="w-full xl:w-6 p-3 flex align-items-center justify-content-center bg-indigo-50 p-4 lg:p-8 mt-5 xl:mt-0" style="border-radius: 30px">
                        <div class="relative w-full" style="padding-bottom: 56.25%; height: 0">
                            <iframe
                                ...
                                width="560"
                                height="315"
                                src="https://www.youtube.com/embed/3NV6X6eiE0k"
        ...
        <BlockViewer header="With 3D Emoji" :code="block7" recent>
            <section style="background-image: url('/images/blocks/hero/hero-11.png')" class="bg-cover z-1">
                <div class="p-6 flex flex-column align-items-center relative overflow-hidden bg-no-repeat bg-cover" style="background: rgba(233, 244, 255, 0.7)">
                    <article class="flex flex-column align-items-center bg-no-repeat z-2">
                        ...
                        <h3 class="text-center font-bold text-3xl md:text-6xl text-black-alpha-80 mt-0 mb-4">
                            ...
                            <span
                                style="
                                    background: linear-gradient(90deg, rgba(0, 209, 255, 1) 0%, rgba(255, 109, 232, 1) 100%);
                    ...
                    <div class="flex flex-column md:flex-row gap-3 mt-4">
                        <Button type="button" label="Documentation" class="p-button-outlined z-2"></Button>
                        <Button type="button" label="Get Started" class="z-2"></Button>
                    </div>
                    <img src="/images/blocks/hero/hero-9.png" alt="Image" class="block mx-auto mt-6 w-full md:w-auto z-1" style="margin-bottom: -3rem" />
                    <img src="/images/blocks/hero/hero-5.png" alt="Image" class="hidden xl:block absolute z-1 xl:z-3" style="top: 66%; left: 73.5%" />
                    <img src="/images/blocks/hero/hero-6.png" alt="Image" class="hidden xl:block absolute z-1 xl:z-3" style="top: 70%; right: 77%" />
                    <img src="/images/blocks/hero/hero-7.png" alt="Image" class="hidden xl:block absolute z-1 xl:z-3" style="top: 22%; left: 70%" />
                    <img src="/images/blocks/hero/hero-8.png" alt="Image" class="hidden xl:block absolute z-1 xl:z-3" style="top: 35%; left: 19%" />
                    <img src="/images/blocks/hero/hero-10.svg" alt="Image" class="hidden xl:block xl:absolute bottom-0" style="mix-blend-mode: overlay" />
                </div>
            </section>
        </BlockViewer>

        <BlockViewer header="With Phone" :code="block8" recent>
            <section class="surface-section px-4 py-8 md:px-6 lg:px-8 overflow-hidden">
                <div class="flex flex-wrap">
                    <article class="w-full mt-8 xl:mt-0 xl:mb-0 xl:w-8 flex flex-column flex-order-1 xl:flex-order-0 justify-content-center align-items-center xl:align-items-start">
                        ...
                        <h2 class="font-bold text-4xl sm:text-7xl mt-0 mb-4">
                            Develop amazing <br />
                            communication.
                        </h2>
                        <div class="flex gap-3">
                            <Button type="button" label="Get Started" icon="pi pi-arrow-right" iconPos="right" class="z-2"></Button>
                            <Button type="button" label="Documentation" class="p-button-outlined z-2"></Button>
                        </div>
                    </article>
                    <div class="w-full xl:w-4 relative flex justify-content-center align-items-center">
                        <img src="/images/blocks/hero/hero-12.png" alt="Image" />
                        <article class="absolute flex align-items-center w-24rem border-round-xl z-2 right-0 md:right-50 gap-3 px-4 py-3" style="bottom: 41%; backdrop-filter: blur(40px); background-color: rgba(255, 255, 255, 0.5)">
                            <img src="/images/blocks/hero/hero-13.png" class="border-circle" alt="Image" />
                            ...
                            <img src="/images/blocks/hero/hero-14.png" class="border-circle" alt="Image" />
                        </article>
                        ...
                        <article class="absolute flex align-items-center w-24rem p-1 border-round-xl z-2 right-0 md:right-50 gap-3 px-4 py-3" style="bottom: 24%; backdrop-filter: blur(40px); background-color: rgba(255, 255, 255, 0.5)">
                            <img src="/images/blocks/hero/hero-15.png" alt="Image" class="border-circle" />
                            <div class="flex flex-column justify-content-center w-full">
                                <p class="m-0 font-semibold text-sm line-height-1.5 text-black-alpha-60">OLYMPIA</p>
                        ...
                        <article class="absolute flex align-items-center w-24rem p-1 border-round-xl z-2 right-0 md:right-50 gap-3 px-4 py-3" style="bottom: 7%; backdrop-filter: blur(40px); background-color: rgba(255, 255, 255, 0.5)">
                            <img src="/images/blocks/hero/hero-13.png" alt="Image" class="border-circle" />
                            <div class="flex flex-column justify-content-center w-full">
                                <p class="m-0 font-semibold text-sm line-height-1.5 text-black-alpha-60">OLYMPIA</p>
                            ...
                            <img src="/images/blocks/hero/hero-16.png" alt="Image" class="border-circle" />
                        </article>
                    </div>
                </div>
            </section>
...
<div class="surface-section px-4 py-8 md:px-6 lg:px-8">
    <div class="flex flex-wrap">
        ...
        <div class="w-full xl:w-6 p-3 flex align-items-center justify-content-center bg-indigo-50 p-4 lg:p-8 mt-5 xl:mt-0" style="border-radius: 30px">
            <div class="relative w-full" style="padding-bottom:56.25%;height:0;">
                <iframe class="absolute top-0 left-0 w-full h-full" width="560" height="315" src="https://www.youtube.com/embed/3NV6X6eiE0k" title="YouTube video player" frameborder="0"
