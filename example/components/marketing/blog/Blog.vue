<template>
    <div>
        <div class="block-category-title">Blog Sections</div>
            ...
            <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
                ...
                <div class="grid nogutter">
                    <div class="col-12 lg:col-4 p-4">
                        ...
                        <div class="text-700 line-height-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
                        <div class="flex mt-4">
                            <Avatar image="/images/blocks/avatars/circle/avatar-f-1.png" shape="circle"></Avatar>
                            <div class="ml-2">
            ...
            <div class="surface-ground px-4 py-8 md:px-6 lg:px-8">
                ...
                <div class="flex flex-column xl:flex-row">
                    <div class="flex shadow-2 surface-card border-round mr-0 xl:mr-4 mb-6 xl:mb-0 flex-column md:flex-row">
                        <img src="/images/blocks/blog/blog-4.jpg" alt="Image" class="border-round-left" style="max-height: 234px" />
                        <div class="p-4">
                            <div class="flex justify-content-between mb-3">
                                <span class="text-orange-500 font-medium">Good News</span>
                                <span class="text-500 text-lg font-medium">3 days ago</span>
                            </div>
                            <div class="font-medium text-900 mb-3 line-height-3">Our Four-Legged Warriors</div>
                            <div class="line-height-3 text-lg text-900 mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</div>
                    ...
                    <div class="flex shadow-2 surface-card border-round flex-column md:flex-row">
                        <img src="/images/blocks/blog/blog-5.jpg" alt="Image" class="border-round-left" style="max-height: 234px" />
                        <div class="p-4">
                            <div class="flex justify-content-between mb-3">
                ...
                <div class="grid grid-nogutter">
                    <div class="col-12 lg:col-4 p-3">
                        <div class="p-3 shadow-2 border-round surface-card h-full">
                            ...
                            <img src="/images/blocks/blog/blog-6.png" alt="Image" class="block w-full mt-5" />
                        </div>
                    </div>
                    <div class="col-12 lg:col-4 p-3">
                        <div class="p-3 shadow-2 border-round surface-card h-full">
                            ...
                            <img src="/images/blocks/blog/blog-7.png" alt="Image" class="block w-full mt-5" />
                        </div>
                    </div>
                    <div class="col-12 lg:col-4 p-3">
                        <div class="p-3 shadow-2 border-round surface-card h-full">
                            ...
                            <img src="/images/blocks/blog/blog-8.png" alt="Image" class="block w-full mt-5" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
                ...
                <div class="flex flex-wrap">
                    <div class="w-full xl:w-6 pr-0 xl:pr-6">
                        <img src="/images/blocks/blog/blog-9.png" alt="Image" class="w-full" />
                        <div class="flex align-items-center mt-4">
                            <img src="/images/blocks/avatars/circle/avatar-f-3.png" class="mr-3 flex-shrink-0" width="28" height="28" />
                    ...
                    <div class="w-full xl:w-6">
                        <div class="flex flex-wrap align-items-start mb-8 mt-8 xl:mb-6 xl:mt-0">
                            <div class="w-full xl:w-6 pr-0 xl:pr-4 mb-4 xl:mb-0">
                                <img src="/images/blocks/blog/blog-10.png" alt="Image" class="w-full" />
                            </div>
                            <div class="w-full xl:w-6">
                                <div class="flex align-items-center">
                                    <img src="/images/blocks/avatars/circle/avatar-f-2.png" class="mr-3 flex-shrink-0" width="28" height="28" />
                        ...
                        <div class="flex flex-wrap align-items-start">
                            <div class="w-full xl:w-6 pr-0 xl:pr-4 mb-4 xl:mb-0">
                                <img src="/images/blocks/blog/blog-11.png" alt="Image" class="w-full" />
                            </div>
                            <div class="w-full xl:w-6">
                                <div class="flex align-items-center">
                                    <img src="/images/blocks/avatars/circle/avatar-f-3.png" class="mr-3 flex-shrink-0" width="28" height="28" />
            ...
            <div class="surface-ground px-4 py-8 md:px-6 lg:px-8">
                ...
                <div class="grid">
                    <div class="col-12 lg:col-6 pr-0 lg:pr-4 mb-6 lg:mb-0">
                        <div style="min-height: 350px; background: url('/images/blocks/blog/blog-12.jpg') no-repeat; background-size: cover" class="mb-6 p-3 flex flex-column justify-content-between">
                    ...
                    <div class="col-12 lg:col-6 pl-2 lg:pl-4">
                        ...
                        <div style="min-height: 350px; background: url('/images/blocks/blog/blog-13.jpg') no-repeat; background-size: cover" class="p-3 flex flex-column justify-content-between">
                            <div class="flex align-items-center mb-3">
                                <span class="bg-teal-100 text-teal-600 text-sm block py-1 px-2 border-round mr-3 font-medium">Science</span>
                                <span class="bg-orange-100 text-orange-600 text-sm block py-1 px-2 border-round font-medium">Travel</span>
                            </div>
        ...
        <BlockViewer header="Gradient Border" :code="block7">
            <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
                ...
                <div class="text-700 line-height-3 text-xl mb-6">Elementum nibh tellus molestie nunc non blandit. Enim eu turpis egestas pretium aenean pharetra.</div>
                ...
                <div class="flex flex-column lg:flex-row gap-5">
                    <div class="shadow-2 border-round-xl" style="background: linear-gradient(15deg, #f91616, #f97316); border-left: 10px solid transparent">
                        <div class="p-4 border-round surface-card h-full">
                            <div class="flex mb-3">
                                <Avatar image="/images/blocks/avatars/circle/avatar-f-4.png" shape="circle"></Avatar>
                                <div class="ml-2">
                            ...
                            <div class="text-xl text-900 font-medium mb-3 line-height-3">'Real and imminent' extinction risk</div>
                            <div class="line-height-3 text-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
                        </div>
                    </div>
                    ...
                    <div class="shadow-2 border-round-xl" style="background: linear-gradient(15deg, #cc63f1, #6366f1); border-left: 10px solid transparent">
                        <div class="p-4 border-round surface-card h-full">
                            <div class="flex mb-3">
                                <Avatar image="/images/blocks/avatars/circle/avatar-f-11.png" shape="circle"></Avatar>
                                <div class="ml-2">
                    ...
                    <div class="shadow-2 border-round-xl" style="background: linear-gradient(15deg, #06d465, #06b6d4); border-left: 10px solid transparent">
                        <div class="p-4 border-round surface-card h-full">
                            <div class="flex mb-3">
                                <Avatar image="/images/blocks/avatars/circle/avatar-m-9.png" shape="circle"></Avatar>
                                <div class="ml-2">
