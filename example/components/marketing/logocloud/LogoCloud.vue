<template>
    <div>
        ...
        <BlockViewer header="Colored" :code="block6" recent>
            <section class="surface-section gap-3 px-4 py-8 md:px-6 lg:px-8">
                ...
                <div class="flex justify-content-evenly flex-wrap">
                    <img src="/images/blocks/logos/peak-indigo.png" alt="Peak" />
                    <img src="/images/blocks/logos/charot-purple.png" alt="Charot" />
                    <img src="/images/blocks/logos/hyper-cyan.png" alt="Hyper" />
                    <img src="/images/blocks/logos/hodly-orange.png" alt="Hodly" />
                    <img src="/images/blocks/logos/franki-green.png" alt="Franki" />
                </div>
            </section>
        </BlockViewer>
    </div>
