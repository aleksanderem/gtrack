    ...
    <div>
        ...
        <BlockViewer header="Simple Centered" :code="block2">
            <div class="surface-section text-center px-4 py-8 md:px-6 lg:px-8">
                <div class="bg-blue-50 text-blue-600 font-bold border-round px-2 py-1 mx-auto mb-3" style="max-width: 350px">🔥&nbsp;3,907 businesses already subscribed</div>
                <div class="text-2xl text-900 font-bold mb-3">Subscribe to our newsletter today</div>
                <p class="text-600 line-height-3 mb-6">Join our community to receieve the latest updates and special promotions.</p>
            ...
            <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
                <div class="py-6 px-3 md:px-6shadow-2 text-center" style="background: linear-gradient(180deg, #6372c3 0%, #3f51b5 100%); border-radius: 1rem">
                    ...
                    <div class="mt-5 mb-3 relative sm:w-20rem mx-auto">
                        ...
                        <Button type="button" class="absolute" label="Join" style="border-radius: 35px; top: 0.25rem; right: 0.25rem; bottom: 0.25rem"></Button>
                    </div>
        ...
        <BlockViewer header="With Image" recent :code="block4">
            <section class="flex flex-column lg:flex-row justify-content-between overflow-hidden gap-4 surface-section py-8">
                <div class="flex flex-column gap-5 pl-4 md:pl-6 lg:pl-8">
                    <h2 class="m-0 font-bold text-900 text-4xl line-height-3">
                        Interactively Enpower <br />
                        Installed Base Users
                    </h2>
                    ...
                    <form class="flex flex-column gap-4 lg:gap-2" @submit="$event.preventDefault()">
                        <div class="flex flex-column align-items-start md:flex-row md:align-items-center gap-3">
                            <InputText placeholder="Email address" class="w-20rem" />
                ...
                <img src="/images/blocks/newsletter/with-image.png" alt="Image" class="-mb-8 ml-4 md:ml-6 lg:ml-0" />
            </section>
        </BlockViewer>
    </div>
</template>
