<template>
    <div>
                    ...
                    <div class="col-12 lg:col-8">
                        <div class="grid">
                            <div class="col-12 lg:col-6 p-3">
                                ...
                                <p class="line-height-3 mt-3 mb-3">
                                    Vulputate ut pharetra sit amet. Netus et malesuada fames ac turpis egestas. Elit eget gravida cum sociis natoque penatibus. Urna id volutpat lacus laoreet non curabitur. In ante metus dictum at.
                                </p>
                                <div class="mb-2">
                            ...
                            <div class="col-12 lg:col-6 p-3">
                                ...
                                <p class="line-height-3 mt-3 mb-3">Risus feugiat in ante metus dictum. Et egestas quis ipsum suspendisse ultrices. Risus pretium quam vulputate dignissim suspendisse. Justo nec ultrices dui sapien.</p>
                                <div class="mb-2">
                                    <a tabindex="0" class="cursor-pointer"><i class="pi pi-twitter text-600 text-xl mr-3"></i></a>
                                    <a tabindex="0" class="cursor-pointer"><i class="pi pi-github text-600 text-xl mr-3"></i></a>
                                    <a tabindex="0" class="cursor-pointer"><i class="pi pi-facebook text-600 text-xl"></i></a>
                            ...
                            <div class="col-12 lg:col-6 p-3">
                                ...
                                <p class="line-height-3 mt-3 mb-3">Donec et odio pellentesque diam volutpat commodo sed egestas. Blandit massa enim nec dui nunc mattis enim ut tellus. Suspendisse faucibus interdum posuere lorem ipsum.</p>
                                <div class="mb-2">
                                    <a tabindex="0" class="cursor-pointer"><i class="pi pi-twitter text-600 text-xl mr-3"></i></a>
                                    <a tabindex="0" class="cursor-pointer"><i class="pi pi-github text-600 text-xl mr-3"></i></a>
                                    <a tabindex="0" class="cursor-pointer"><i class="pi pi-facebook text-600 text-xl"></i></a>
                            ...
                            <div class="col-12 lg:col-6 p-3">
                                ...
                                <span class="text-600 font-medium">UI/UX Designer</span>
                                <p class="line-height-3 mt-3 mb-3">Pretium aenean pharetra magna ac placerat vestibulum. Est ullamcorper eget nulla facilisi etiam dignissim diam quis enim. Fringilla urna porttitor rhoncus dolor purus non enim..</p>
                                <div class="mb-2">
                                    <a tabindex="0" class="cursor-pointer"><i class="pi pi-twitter text-600 text-xl mr-3"></i></a>
                                    <a tabindex="0" class="cursor-pointer"><i class="pi pi-github text-600 text-xl mr-3"></i></a>
                                    <a tabindex="0" class="cursor-pointer"><i class="pi pi-facebook text-600 text-xl"></i></a>
        ...
        <BlockViewer header="With Glass Overlay" :code="block6" recent>
                    ...
                    <div class="col-12">
                        <div class="grid mt-4">
                            <article class="col-12 md:col-6 lg:col-3 mb-5 lg:mb-0">
                                <div class="mb-3 relative h-25rem border-round bg-cover bg-no-repeat" style="background-image: url('/images/blocks/team/team-9.png')">
                                    <div
                                        class="border-round p-3 absolute text-white inline-flex flex-column justify-content-center font-semibold"
                                        style="bottom: 1rem; left: 1rem; width: calc(100% - 2rem); background: linear-gradient(90deg, rgba(0, 0, 0, 0.4), rgba(255, 255, 255, 0.4) 100%); backdrop-filter: blur(6px)"
                                    >
                            ...
                            <article class="col-12 md:col-6 lg:col-3 mb-5 lg:mb-0">
                                <div class="mb-3 relative h-25rem border-round bg-cover bg-no-repeat" style="background-image: url('/images/blocks/team/team-10.png')">
                                    <div
                                        class="border-round p-3 absolute text-white inline-flex flex-column justify-content-center font-semibold"
                                        style="bottom: 1rem; left: 1rem; width: calc(100% - 2rem); background: linear-gradient(90deg, rgba(0, 0, 0, 0.4), rgba(255, 255, 255, 0.4) 100%); backdrop-filter: blur(6px)"
                                    >
                            ...
                            <article class="col-12 md:col-6 lg:col-3 mb-5 lg:mb-0">
                                <div class="mb-3 relative h-25rem border-round bg-cover bg-no-repeat" style="background-image: url('/images/blocks/team/team-11.png')">
                                    <div
                                        class="border-round p-3 absolute text-white inline-flex flex-column justify-content-center font-semibold"
                                        style="bottom: 1rem; left: 1rem; width: calc(100% - 2rem); background: linear-gradient(90deg, rgba(0, 0, 0, 0.4), rgba(255, 255, 255, 0.4) 100%); backdrop-filter: blur(6px)"
                                    >
                            ...
                            <article class="col-12 md:col-6 lg:col-3 mb-5 lg:mb-0">
                                <div class="mb-3 relative h-25rem border-round bg-cover bg-no-repeat" style="background-image: url('/images/blocks/team/team-12.png')">
                                    <div
                                        class="border-round p-3 absolute text-white inline-flex flex-column justify-content-center font-semibold"
                                        style="bottom: 1rem; left: 1rem; width: calc(100% - 2rem); background: linear-gradient(90deg, rgba(0, 0, 0, 0.4), rgba(255, 255, 255, 0.4) 100%); backdrop-filter: blur(6px)"
                                    >
                            ...
                            <article class="col-12 md:col-6 lg:col-3 mb-5 lg:mb-0">
                                <div class="mb-3 relative h-25rem border-round bg-cover bg-no-repeat" style="background-image: url('/images/blocks/team/team-13.png')">
                                    <div
                                        class="border-round p-3 absolute text-white inline-flex flex-column justify-content-center font-semibold"
                                        style="bottom: 1rem; left: 1rem; width: calc(100% - 2rem); background: linear-gradient(90deg, rgba(0, 0, 0, 0.4), rgba(255, 255, 255, 0.4) 100%); backdrop-filter: blur(6px)"
                                    >
                            ...
                            <article class="col-12 md:col-6 lg:col-3 mb-5 lg:mb-0">
                                <div class="mb-3 relative h-25rem border-round bg-cover bg-no-repeat" style="background-image: url('/images/blocks/team/team-14.png')">
                                    <div
                                        class="border-round p-3 absolute text-white inline-flex flex-column justify-content-center font-semibold"
                                        style="bottom: 1rem; left: 1rem; width: calc(100% - 2rem); background: linear-gradient(90deg, rgba(0, 0, 0, 0.4), rgba(255, 255, 255, 0.4) 100%); backdrop-filter: blur(6px)"
                                    >
                            ...
                            <article class="col-12 md:col-6 lg:col-3 mb-5 lg:mb-0">
                                <div class="mb-3 relative h-25rem border-round bg-cover bg-no-repeat" style="background-image: url('/images/blocks/team/team-15.png')">
                                    <div
                                        class="border-round p-3 absolute text-white inline-flex flex-column justify-content-center font-semibold"
                                        style="bottom: 1rem; left: 1rem; width: calc(100% - 2rem); background: linear-gradient(90deg, rgba(0, 0, 0, 0.4), rgba(255, 255, 255, 0.4) 100%); backdrop-filter: blur(6px)"
                                    >
                            ...
                            <article class="col-12 md:col-6 lg:col-3 mb-5 lg:mb-0">
                                <div class="mb-3 relative h-25rem border-round bg-cover bg-no-repeat" style="background-image: url('/images/blocks/team/team-16.png')">
                                    <div
                                        class="border-round p-3 absolute text-white inline-flex flex-column justify-content-center font-semibold"
                                        style="bottom: 1rem; left: 1rem; width: calc(100% - 2rem); background: linear-gradient(90deg, rgba(0, 0, 0, 0.4), rgba(255, 255, 255, 0.4) 100%); backdrop-filter: blur(6px)"
                                    >
