<template>
    <div>
        <div class="block-category-title">Navigation Bar</div>
        <BlockViewer header="Centered Menu" :code="block1" :previewStyle="{ height: '600px' }">
            <div class="surface-overlay py-3 px-6 shadow-2 flex align-items-center justify-content-between relative lg:static">
                <img src="/images/blocks/logos/hyper.svg" alt="Image" height="50" />
                <a
                    v-ripple
        ...
        <BlockViewer header="Left Aligned MegaMenu" :code="block2" :previewStyle="{ height: '600px' }">
            <div class="surface-overlay py-3 px-6 shadow-2 flex align-items-center justify-content-between relative lg:static">
        ...
        <BlockViewer header="Colored Right Aligned Menu" :code="block3" :previewStyle="{ height: '600px' }">
            <div class="bg-indigo-500 py-3 px-6 shadow-2 flex align-items-center justify-content-between relative lg:static">
                ...
                <a
                    v-ripple
                    class="cursor-pointer block lg:hidden text-white mt-1 p-ripple"
                    v-styleclass="{
                        selector: '@next',
                        enterClass: 'hidden',
                        leaveToClass: 'hidden',
                ...
                <div class="align-items-center flex-grow-1 lg:justify-content-end hidden lg:flex absolute lg:static w-full bg-indigo-500 left-0 top-100 px-6 lg:px-0 z-3 shadow-2 lg:shadow-none">
                    <ul class="list-none p-0 m-0 flex lg:align-items-center text-white select-none flex-column lg:flex-row cursor-pointer">
                        <li class="relative">
                            <a
                                v-ripple
                                class="flex px-0 lg:px-5 py-3 align-items-center hover:text-indigo-100 font-medium transition-colors transition-duration-150 p-ripple"
                                v-styleclass="{
                                    selector: '@next',
                                    enterClass: 'hidden',
                                    enterActiveClass: 'scalein',
                        ...
                        <li>
                            <a v-ripple class="flex px-0 lg:px-5 py-3 hover:text-indigo-100 font-medium transition-colors transition-duration-150 p-ripple">
                                <span>Corporate</span>
                            </a>
                        </li>
                        <li>
                    ...
                    <div class="flex justify-content-between lg:block border-top-1 lg:border-top-none surface-border py-3 lg:py-0 mt-3 lg:mt-0 lg:ml-5">
                        <Button label="Login" icon="pi pi-user" class="p-button font-bold"></Button>
                    </div>
                </div>
            </div>
        </BlockViewer>

        <BlockViewer header="Centered Logo" :code="block4" :previewStyle="{ height: '600px' }">
            <div class="surface-overlay py-3 px-6 shadow-2 flex align-items-center justify-content-between relative lg:static">
                <img src="/images/blocks/logos/hyper-700.svg" alt="Image" height="50" class="block lg:hidden" />
                <a
                    v-ripple
                    class="cursor-pointer block lg:hidden text-700 mt-1 p-ripple"
                    v-styleclass="{
                ...
                <div class="align-items-center flex-grow-1 hidden lg:flex absolute lg:static w-full surface-overlay left-0 top-100 px-6 lg:px-0 z-2 shadow-2 lg:shadow-none">
                    ...
                    <div class="w-4 text-center hidden lg:block">
                        <img src="/images/blocks/logos/hyper-700.svg" alt="Image" height="50" />
                    </div>
                    <div class="flex justify-content-end lg:text-right lg:block border-top-1 lg:border-top-none surface-border py-3 lg:py-0 mt-3 lg:mt-0 lg:w-4">
                        <Button label="Login" class="font-bold p-button-outlined p-button-rounded"></Button>
                        <Button label="Register" class="ml-3 font-bold p-button-rounded"></Button>
                    </div>
                </div>
            </div>
        </BlockViewer>

        <BlockViewer header="Full Height Menu" :code="block5" :previewStyle="{ height: '600px' }">
            <div class="surface-overlay shadow-2 flex relative lg:static align-items-center lg:align-items-stretch" style="min-height: 5rem">
                ...
                <a
                    v-ripple
                    class="cursor-pointer block lg:hidden text-700 mr-6 mt-1 ml-auto p-ripple"
                    v-styleclass="{
                        selector: '@next',
                        enterClass: 'hidden',
                        leaveToClass: 'hidden',
                ...
                <div class="flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full surface-overlay left-0 top-100 px-0 pt-3 lg:pt-0 z-1 shadow-2 lg:shadow-none">
                    <ul class="list-none p-0 m-0 flex text-900 select-none flex-column lg:flex-row cursor-pointer">
                        <li class="relative">
                            <a
                                v-ripple
                                class="flex px-6 lg:px-5 py-3 lg:py-0 h-full align-items-center hover:surface-50 font-medium transition-colors transition-duration-150 p-ripple"
                                v-styleclass="{
                                    selector: '@next',
                                    enterClass: 'hidden',
                                    enterActiveClass: 'scalein',
                        ...
                        <li>
                            <a v-ripple class="flex px-6 lg:px-5 py-3 lg:py-0 h-full align-items-center hover:surface-50 font-medium transition-colors transition-duration-150 p-ripple">
                                <span>Corporate</span>
                            </a>
                        </li>
                        <li>
                    ...
                    <div class="flex justify-content-between lg:block border-top-1 lg:border-top-none surface-border py-3 lg:py-0 px-6 lg:px-0 mt-3 lg:mt-0">
                        <Button label="Login" class="p-button-text font-bold h-full" style="border-radius: 0"></Button>
                        <Button label="Register" class="ml-3 font-bold h-full" style="border-radius: 0"></Button>
                    </div>
                </div>
            </div>
        </BlockViewer>

        <BlockViewer header="Dark Mega Menu" :code="block6" :previewStyle="{ height: '600px' }">
                ...
                <div class="align-items-center flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full bg-gray-900 left-0 top-100 px-6 lg:px-0 shadow-2 lg:shadow-none">
                    ...
                    <ul class="list-none p-0 m-0 flex lg:align-items-center text-gray-400 select-none flex-column lg:flex-row">
                        <li>
                            <a
                                v-ripple
                                class="flex px-0 lg:px-5 py-3 align-items-center hover:text-blue-600 font-medium transition-colors transition-duration-150 cursor-pointer p-ripple"
                                v-styleclass="{
                                    selector: '@next',
                                    enterClass: 'hidden',
                                    enterActiveClass: 'scalein',
                        ...
                        <li>
                            <a v-ripple class="flex px-0 lg:px-5 py-3 hover:text-blue-600 font-medium transition-colors transition-duration-150 cursor-pointer p-ripple">
                                <span>Corporate</span>
                            </a>
                        </li>
                        <li>
        ...
        <BlockViewer header="Mega Menu with Featured Section" :code="block7" :previewStyle="{ height: '700px' }" recent>
            <section class="h-full bg-cover" style="background-image: url('/images/blocks/navbar/navbar-3.jpg')">
                <div class="py-3 px-6 shadow-2 flex align-items-center justify-content-between relative bg-black-alpha-50">
                    <img src="/images/blocks/logos/peak-300.svg" alt="Image" height="50" />
                    <a
                        v-ripple
                    ...
                    <nav class="align-items-center flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full left-0 top-100 px-6 lg:px-0 shadow-2 lg:shadow-none lg:bg-transparent" style="background-color: rgba(0, 0, 0, 0.5)">
                        <ul class="list-none p-0 m-0 lg:m-auto flex lg:align-items-center text-gray-400 select-none flex-column lg:flex-row">
                                        ...
                                        <div class="w-full xl:w-6 lg:px-5 xl:p-2">
                                            <div class="flex lg:flex-column flex-wrap xl:flex-nowrap py-4 pb-3 mb-3">
                                                ...
                                                <div class="p-2 lg:w-full flex flex-column sm:flex-row sm:align-items-center" style="min-width: 10rem">
                                                    <img src="/images/blocks/navbar/navbar-1.jpeg" class="h-5rem w-10rem xl:h-5rem border-round mr-2" alt="Image" />
                                                ...
                                                <div class="mt-3 sm:mt-0 p-2 lg:w-full flex flex-column sm:flex-row sm:align-items-center" style="min-width: 10rem">
                                                    <img src="/images/blocks/navbar/navbar-2.jpeg" class="h-5rem w-10rem xl:h-5rem border-round mr-2" alt="Image" />
                                                    <div class="mt-3 sm:mt-0 sm:ml-2 w-full sm:w-8">
                            ...
                            <li>
                                <a v-ripple class="p-ripple flex align-items-center px-0 px-3 xl:px-5 py-3 hover:text-blue-600 font-medium transition-colors transition-duration-150 cursor-pointer">
                        ...
                        <div class="flex justify-content-between lg:block border-top-1 lg:border-top-none py-3 lg:py-0 mt-3 lg:mt-0" style="border-color: rgba(222, 226, 230, 0.15)">
                            <Button label="Sign In" icon="pi pi-chevron-right" iconPos="right" class="p-button-rounded font-bold"></Button>
                        </div>
                    </nav>
                </div>
            </section>
...
<div class="bg-indigo-500 py-3 px-6 shadow-2 flex align-items-center justify-content-between relative lg:static">
    <img src="/images/blocks/logos/hyper-light.svg" alt="Image" height="50" />
    <a v-ripple class="cursor-pointer block lg:hidden text-white mt-1 p-ripple"
        v-styleclass="{ selector: '@next', enterClass: 'hidden', leaveToClass: 'hidden', hideOnOutsideClick: true }">
        <i class="pi pi-bars text-4xl"></i>
    </a>
    <div class="align-items-center flex-grow-1 lg:justify-content-end hidden lg:flex absolute lg:static w-full bg-indigo-500 left-0 top-100 px-6 lg:px-0 z-3 shadow-2 lg:shadow-none">
        <ul class="list-none p-0 m-0 flex lg:align-items-center text-white select-none flex-column lg:flex-row cursor-pointer">
            <li class="relative">
                <a v-ripple class="flex px-0 lg:px-5 py-3 align-items-center hover:text-indigo-100 font-medium transition-colors transition-duration-150 p-ripple"
                    v-styleclass="{ selector: '@next', enterClass: 'hidden', enterActiveClass: 'scalein', leaveToClass: 'hidden', leaveActiveClass: 'fadeout', hideOnOutsideClick: true }">
                    <span>Products</span>
                    <i class="pi pi-chevron-down ml-auto lg:ml-3"></i>
                </a>
...
<div class="surface-overlay shadow-2 flex relative lg:static align-items-center lg:align-items-stretch" style="min-height: 5rem">
    ...
    <a v-ripple class="cursor-pointer block lg:hidden text-700 mr-6 mt-1 ml-auto p-ripple"
        v-styleclass="{ selector: '@next', enterClass: 'hidden', leaveToClass: 'hidden', hideOnOutsideClick: true }">
        <i class="pi pi-bars text-4xl"></i>
    </a>
    <div class="flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full surface-overlay left-0 top-100 px-0 pt-3 lg:pt-0 z-1 shadow-2 lg:shadow-none">
...
<section class="h-full bg-cover" style="background-image: url('/images/blocks/navbar/navbar-3.jpg');">
    <div class="py-3 px-6 shadow-2 flex align-items-center justify-content-between relative bg-black-alpha-50">
        <img src="/images/blocks/logos/peak-300.svg" alt="Image" height="50" />
        <a v-ripple class="p-ripple cursor-pointer block lg:hidden text-gray-400" v-styleclass="{ selector: '@next', enterClass: 'hidden', leaveToClass: 'hidden', hideOnOutsideClick: true }">
            <i class="pi pi-bars text-4xl text-white"></i>
        </a>
        <nav class="align-items-center flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full left-0 top-100 px-6 lg:px-0 shadow-2 lg:shadow-none lg:bg-transparent" style="background-color: rgba(0, 0, 0, 0.5);">
            <ul class="list-none p-0 m-0 lg:m-auto flex lg:align-items-center text-gray-400 select-none flex-column lg:flex-row">
                <li>
                    <a v-ripple class="p-ripple flex px-0 px-3 xl:px-5 py-3 align-items-center hover:text-blue-600 font-medium transition-colors transition-duration-150 cursor-pointer"
                    v-styleclass="{ selector: '@next', enterClass: 'hidden', leaveToClass: 'hidden', leaveActiveClass: 'fadeout', hideOnOutsideClick: true }">
                        <span class="text-white font-semibold text-xl">Product</span>
                    </a>
                    <div class="lg:absolute hidden origin-top left-0 top-100 w-full p-4 overflow-y-scroll" style="background-color: rgba(0, 0, 0, 0.5); backdrop-filter: blur(100px); min-height: 30rem;">
                        <div class="flex h-full flex-wrap">
