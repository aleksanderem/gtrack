            ...
            <div class="min-h-screen flex relative lg:static surface-ground">
                    ...
                    <div class="flex h-full">
                        <div class="flex flex-column h-full bg-indigo-500 flex-shrink-0 select-none">
                            ...
                            <div class="overflow-y-auto mt-3">
                                <ul class="list-none py-3 px-2 m-0">
                                    <li class="mb-2">
                                        <a
                                            v-ripple
                                            class="flex align-items-center cursor-pointer p-3 lg:justify-content-center hover:bg-indigo-400 border-round text-indigo-100 hover:text-indigo-50 transition-duration-150 transition-colors p-ripple"
                                            @click="activeTab1 = 0"
                            ...
                            <div class="mt-auto">
                                ...
                                <a v-ripple class="m-3 flex align-items-center cursor-pointer py-1 px-0 justify-content-center hover:bg-indigo-400 border-round text-300 hover:text-0 transition-duration-150 transition-colors p-ripple">
                ...
                <div class="min-h-screen flex flex-column relative flex-auto">
                    ...
                    <div class="p-5 flex flex-column flex-auto">
                        <div class="border-2 border-dashed border-round surface-border surface-section flex-auto"></div>
                    </div>
                </div>
            </div>
        </BlockViewer>
            ...
            <div class="min-h-screen flex relative lg:static surface-ground">
                ...
                <div class="min-h-screen flex flex-column relative flex-auto">
                    <div class="flex justify-content-between align-items-center px-5 surface-section relative lg:static border-bottom-1 surface-border" style="height: 60px">
                        ...
                        <ul
                            id="topbarmenu"
                            class="list-none p-0 m-0 hidden lg:flex lg:align-items-center select-none lg:flex-row lg:ml-auto surface-section border-1 lg:border-none surface-border right-0 top-100 z-1 shadow-2 lg:shadow-none absolute lg:static"
                        >
                            <li>
                                <a v-ripple class="flex p-3 lg:px-3 lg:py-2 align-items-center text-600 hover:text-900 hover:surface-100 font-medium border-round cursor-pointer transition-duration-150 transition-colors p-ripple">
                                    <i class="pi pi-inbox text-base lg:text-2xl mr-2 lg:mr-0"></i>
                        ...
                        <a
                            v-ripple
                            class="cursor-pointer block text-700 ml-3 p-ripple"
                            v-styleclass="{
            ...
            <div class="min-h-screen flex relative lg:static surface-ground">
                    ...
                    <div class="flex h-full">
                        <div class="flex flex-column h-full bg-indigo-900 flex-shrink-0 select-none">
                            ...
                            <div class="overflow-y-auto mt-3">
                                <ul class="list-none py-3 pl-2 pr-0 m-0">
                                    <li class="mb-2">
                                        <a
                                            v-ripple
                                            class="flex align-items-center cursor-pointer py-3 pl-0 pr-2 justify-content-center hover:bg-indigo-600 text-indigo-100 hover:text-indigo-50 transition-duration-150 transition-colors p-ripple"
                                            @click="activeTab2 = 0"
                                            :class="{ 'bg-indigo-500': activeTab2 === 0 }"
                                    ...
                                    <li class="mb-2">
                                        <a
                                            ...
                                            class="flex align-items-center cursor-pointer py-3 pl-0 pr-2 justify-content-center hover:bg-indigo-600 text-indigo-100 hover:text-indigo-50 transition-duration-150 transition-colors p-ripple"
                                            @click="activeTab2 = 1"
                                            :class="{ 'bg-indigo-500': activeTab2 === 1 }"
                                            style="border-top-left-radius: 30px; border-bottom-left-radius: 30px"
                                        >
                                    ...
                                    <li class="mb-2">
                                        <a
                                            ...
                                            class="flex align-items-center cursor-pointer py-3 pl-0 pr-2 justify-content-center hover:bg-indigo-600 text-indigo-100 hover:text-indigo-50 transition-duration-150 transition-colors p-ripple"
                                            @click="activeTab2 = 2"
                                            :class="{ 'bg-indigo-500': activeTab2 === 2 }"
                                            style="border-top-left-radius: 30px; border-bottom-left-radius: 30px"
                                        >
                                    ...
                                    <li class="mb-2">
                                        <a
                                            ...
                                            class="flex align-items-center cursor-pointer py-3 pl-0 pr-2 justify-content-center hover:bg-indigo-600 text-indigo-100 hover:text-indigo-50 transition-duration-150 transition-colors p-ripple"
                                            @click="activeTab2 = 3"
                                            :class="{ 'bg-indigo-500': activeTab2 === 3 }"
                                            style="border-top-left-radius: 30px; border-bottom-left-radius: 30px"
                                        >
                                    ...
                                    <li class="mb-2">
                                        <a
                                            ...
                                            class="flex align-items-center cursor-pointer py-3 pl-0 pr-2 justify-content-center hover:bg-indigo-600 text-indigo-100 hover:text-indigo-50 transition-duration-150 transition-colors p-ripple"
                                            @click="activeTab2 = 4"
                                            :class="{ 'bg-indigo-500': activeTab2 === 4 }"
                                            style="border-top-left-radius: 30px; border-bottom-left-radius: 30px"
                                        >
                                    ...
                                    <li class="mb-2">
                                        <a
                                            ...
                                            class="flex align-items-center cursor-pointer py-3 pl-0 pr-2 justify-content-center hover:bg-indigo-600 text-indigo-100 hover:text-indigo-50 transition-duration-150 transition-colors p-ripple"
                                            @click="activeTab2 = 5"
                                            :class="{ 'bg-indigo-500': activeTab2 === 5 }"
                                            style="border-top-left-radius: 30px; border-bottom-left-radius: 30px"
                                        >
                            ...
                            <div class="mt-auto">
                                ...
                                <a v-ripple class="m-3 flex align-items-center cursor-pointer p-2 justify-content-center hover:bg-indigo-600 border-round text-300 hover:text-0 transition-duration-150 transition-colors p-ripple">
                                    <img src="/images/blocks/avatars/circle/avatar-f-1.png" style="width: 24px; height: 24px" />
                                </a>
                            </div>
                        </div>
                ...
                <div class="min-h-screen flex flex-column relative flex-auto">
                    <div class="flex justify-content-between lg:justify-content-start align-items-center px-5 surface-section border-bottom-1 surface-border relative lg:static" style="height: 60px">
                        ...
                        <ul class="list-none p-0 m-0 hidden lg:flex lg:align-items-center select-none lg:flex-row lg:w-full surface-section border-1 lg:border-none surface-border right-0 top-100 z-1 shadow-2 lg:shadow-none absolute lg:static">
                            <li>
                                <a v-ripple class="flex p-3 lg:px-3 lg:py-2 align-items-center text-600 hover:text-900 hover:surface-100 font-medium border-round cursor-pointer transition-duration-150 transition-colors p-ripple">
                                    <i class="pi pi-inbox text-base lg:text-2xl mr-2 lg:mr-0"></i>
                                    <span class="block lg:hidden font-medium">Inbox</span>
