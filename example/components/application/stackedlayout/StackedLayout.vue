        ...
        <BlockViewer header="Tabs" :code="block6">
            <div class="min-h-screen flex flex-column surface-ground">
                <div class="surface-section pl-6 flex justify-content-between relative lg:static" style="min-height: 70px">
                    ...
                    <div
                        class="cursor-pointer block lg:hidden align-self-center p-ripple text-700 pr-6"
                        v-styleclass="{
                            selector: '@next',
                            enterClass: 'hidden',
                            leaveToClass: 'hidden',
                        ...
                        <ul class="list-none p-0 m-0 flex select-none flex-column lg:flex-row gap-2">
                            <li class="lg:flex lg:align-items-end">
                                <a
                                    ...
                                    :class="{
                                        'surface-ground text-900': activeTab === 0,
                                        'hover:surface-hover': activeTab !== 0
                                    }"
                                    @click="activeTab = 0"
                                >
                                    <i class="pi pi-home mr-2"></i>
                            ...
                            <li class="lg:flex lg:align-items-end">
                                <a
                                    ...
                                    :class="{
                                        'surface-ground text-900': activeTab === 1,
                                        'hover:surface-hover': activeTab !== 1
                                    }"
                                    @click="activeTab = 1"
                                >
                                    <i class="pi pi-chart-line mr-2"></i>
                            ...
                            <li class="lg:flex lg:align-items-end">
                                <a
                                    ...
                                    class="border-round-top flex align-items-center px-6 py-3 lg:px-3 lg:py-3 text-900 font-medium cursor-pointer transition-colors transition-duration-150 p-ripple"
                                    :class="{
                                        'surface-ground text-900': activeTab === 2,
                                        'hover:surface-hover': activeTab !== 2
                                    }"
                                    @click="activeTab = 2"
                                >
                                    <i class="pi pi-users mr-2"></i>
                            ...
                            <li class="lg:flex lg:align-items-end">
                                <a
                                    ...
                                    class="border-round-top flex align-items-center px-6 py-3 lg:px-3 lg:py-3 text-900 font-medium cursor-pointer transition-colors transition-duration-150 p-ripple"
                                    :class="{
                                        'surface-ground text-900': activeTab === 3,
                                        'hover:surface-hover': activeTab !== 3
                                    }"
                                    @click="activeTab = 3"
                                >
        ...
        <BlockViewer header="Hover Borders" :code="block7">
            <div class="min-h-screen flex flex-column surface-ground">
                <div class="surface-overlay px-6 flex justify-content-between relative lg:static" style="min-height: 80px">
                    ...
                    <a
                        v-ripple
                        class="cursor-pointer block lg:hidden text-700 align-self-center p-ripple"
                        v-styleclass="{
                            selector: '@next',
                            enterClass: 'hidden',
                            leaveToClass: 'hidden',
