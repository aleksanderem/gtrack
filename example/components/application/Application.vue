                    ...
                    <div class="grid">
                        ...
                        <div class="col-12 md:col-3">
                            <router-link to="/application/commandmenu">
                                <img :src="$appState.dark ? 'images/placeholders/placeholder-commandmenu-dark.svg' : 'images/placeholders/placeholder-commandmenu.svg'" class="block-placeholder" alt="CommandMenu" />
                            </router-link>
                            <div class="flex align-items-start justify-content-between">
                                <div>
