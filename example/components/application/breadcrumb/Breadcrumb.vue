<template>
    <div>
        <div class="block-category-title">Breadcrumb</div>
        <BlockViewer header="Simple with Angle Icon" :code="block1" containerClass="px-4 py-8 md:px-6 lg:px-8">
        ...
        <BlockViewer header="Full Height Icon" :code="block2" containerClass="px-4 py-8 md:px-6 lg:px-8">
        ...
        <BlockViewer header="Colored" :code="block3" containerClass="px-4 py-8 md:px-6 lg:px-8 flex justify-content-center">
        ...
        <BlockViewer header="Rounded" :code="block4" containerClass="px-4 py-8 md:px-6 lg:px-8 flex justify-content-center">
            <ul class="list-none p-0 m-0 flex font-medium overflow-x-auto" style="border-radius: 30px">
                ...
                <li class="bg-cyan-500 z-4">
                    <a class="cursor-pointer bg-cyan-500 flex align-items-center justify-content-center px-5 py-3 text-white white-space-nowrap shadow-2 h-full" style="border-top-right-radius: 30px; border-bottom-right-radius: 30px"> Level 3 </a>
                </li>
                <li class="surface-card z-3">
                    <a class="cursor-pointer bg-cyan-500 flex align-items-center justify-content-center px-5 py-3 text-white white-space-nowrap shadow-2 h-full" style="border-top-right-radius: 30px; border-bottom-right-radius: 30px"> Level 2 </a>
                </li>
                <li>
                    <a class="cursor-pointer text-cyan-700 flex align-items-center justify-content-center px-5 py-3 surface-card white-space-nowrap h-full" style="border-top-right-radius: 30px; border-bottom-right-radius: 30px"> Level 1 </a>
                </li>
            </ul>
        </BlockViewer>

        <BlockViewer header="Simple with Slash" :code="block5" containerClass="px-4 py-8 md:px-6 lg:px-8">
            <ul class="list-none p-3 m-0 surface-card flex align-items-center font-medium overflow-x-auto">
                <li class="pr-3">
                    <a class="cursor-pointer">
                        <i class="pi pi-home text-blue-500"></i>
