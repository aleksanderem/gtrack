<template>
    <div>
                ...
                <div class="flex flex-column h-full">
                    <div class="flex align-items-start bg-gray-800 justify-content-between p-3">
                        ...
                        <div>
                            <Button
                                icon="pi pi-times"
                                class="p-button-rounded p-button-text p-button-warning p-button-plain"
                                v-styleclass="{
                                    selector: '#slideover-4',
                                    leaveToClass: 'hidden',
                                    leaveActiveClass: 'fadeoutright'
            ...
            <div id="slideover-5" class="hidden surface-overlay absolute top-0 right-0 shadow-2 w-18rem h-full">
                <div class="flex flex-column p-4 h-full w-18rem">
                    ...
                    <div class="pt-3 border-top-1 surface-border mt-3 flex">
                        <Button
                            icon="pi pi-times"
                            class="p-button-text mr-2 flex-auto"
                            label="Cancel"
                            v-styleclass="{
                                selector: '#slideover-5',
                                leaveToClass: 'hidden',
                    ...
                    <div class="flex-auto overflow-y-auto">
                        ...
                        <div class="flex align-items-center mb-5">
                            <a class="cursor-pointer flex flex-column flex-grow-1 align-items-center gap-2">
                                <div v-ripple class="surface-100 hover:surface-200 transition-colors transition-duration-150 p-3 border-round-2xl p-ripple">
                        ...
                        <div style="width: 70px" class="flex border-right-1 surface-border flex-shrink-0">
                            <ul class="flex flex-column list-none p-0 m-0 w-full">
                                <li v-for="(usr, i) of users" :key="i">
                                    <a
                                        v-ripple
                                        class="cursor-pointer flex align-items-center justify-content-center border-right-2 border-transparent p-2 hover:border-300 transition-colors transition-duration-150 p-ripple"
                                        :class="{ 'border-blue-500 surface-200': i === user }"
                                        @click="user = i"
                                    >
                        ...
                        <div class="flex flex-auto flex-column overflow-y-auto surface-ground">
                            <ul class="flex-auto list-none p-0 m-0" v-if="user === 2">
                                <li class="flex justify-content-end p-3">
                                    <div>
                                        <p class="shadow-2 bg-blue-600 text-white p-3 line-height-3 border-round mt-0 mb-2" style="max-width: 275px">
                                            Neque vitae tempus quam pellentesque nec nam aliquam sem. Etiam tempor orci eu lobortis elementum.
                                        </p>
                            ...
                            <div class="p-4 surface-overlay border-top-1 surface-border p-input-filled">
                                <span class="p-input-icon-right block">
                                    ...
                                    <InputText type="text" class="p-3 w-full" placeholder="Type..." />
                                </span>
                            </div>
                        </div>
                    </div>
        ...
        <BlockViewer header="Form" :code="block11" containerClass="flex align-items-start justify-content-end px-4 py-8 md:px-6 lg:px-8 relative overflow-hidden" :previewStyle="{ height: '100vh' }" recent>
            <Button
                label="Display"
                icon="pi pi-arrow-left"
                v-styleclass="{
                ...
                <div class="flex flex-column justify-content-between h-full">
                    <form>
                        <div class="flex align-items-start bg-blue-700 justify-content-between p-3 mb-4">
                            <header>
                                <h1 class="text-0 mt-0 text-xl font-medium mb-1 text-white">Title Placeholder</h1>
                                <h2 class="m-0 p-0 line-height-3 font-normal text-primary-200 text-sm">Nunc mi ipsum faucibus vitae aliquet nec. Lacus sed viverra tellus in hac habitasse.</h2>
                            </header>
                            <div>
                                <Button
                                    icon="pi pi-times"
                                    class="p-button-rounded p-button-text text-white-alpha-70 p-button-plain hover:bg-blue-500"
                                    pStyleClass="#slideover-11"
                                    leaveToClass="hidden"
                                    leaveActiveClass="fadeoutright"
                                    v-styleclass="{
                                        selector: '#slideover-11',
                        ...
                        <div class="px-4 mt-4">
                            ...
                            <div class="mt-2 p-fluid">
                                <Chips v-model="value"></Chips>
                            </div>
                        </div>
                        <div class="px-4 mt-4">
                            <h3 class="text-base font-semibold text-color mt-0 mb-0">Team Members</h3>
                            <div class="mt-3 flex gap-3">
                                <Avatar image="/images/blocks/avatars/circle/avatar-f-1.png" v-badge="4" size="large"></Avatar>
                                <Avatar image="/images/blocks/avatars/circle/avatar-f-2.png" v-badge="8" size="large"></Avatar>
                                <Avatar image="/images/blocks/avatars/circle/avatar-f-3.png" v-badge="9" size="large"></Avatar>
                                <Avatar image="/images/blocks/avatars/circle/avatar-f-4.png" v-badge="3" size="large"></Avatar>
                            </div>
                        </div>
                        <div class="px-4 mt-4">
                            <h3 class="text-base font-semibold text-color">Newsletter Permissions</h3>
                            <div class="mt-3 flex align-items-center gap-3">
                                <InputSwitch v-model="checked" class="flex"></InputSwitch>
                                <p class="mt-0 mb-0 text-base text-color">Allow sending Marketing emails</p>
                            </div>
                            <div class="mt-3 flex align-items-center gap-3">
                                <InputSwitch v-model="checked1" class="flex"></InputSwitch>
                                <p class="mt-0 mb-0 text-base">Allow sending Release emails</p>
                            </div>
                            <div class="mt-3 flex align-items-center gap-3">
                                <InputSwitch v-model="checked2" class="flex"></InputSwitch>
...
<div id="slideover-10" class="hidden surface-overlay h-full absolute top-0 right-0 shadow-2 w-24rem">
    <div class="flex flex-column p-4 h-full">
        ...
        <TabView>
            ...
            block11: `
<Button label="Display" icon="pi pi-arrow-left" v-styleclass="{ selector: '#slideover-11', enterActiveClass:'fadeinright', enterClass:'hidden', leaveToClass: 'hidden', leaveActiveClass: 'fadeoutright', hideOnOutsideClick: 'true' }"></Button>
    ...
    <div class="flex flex-column justify-content-between h-full">
        <form>
            <div class="flex align-items-start bg-blue-700 justify-content-between p-3 mb-4">
                <header>
                    <h1 class="text-0 mt-0 text-xl font-medium mb-1 text-white">Title Placeholder</h1>
                    <h2 class="m-0 p-0 line-height-3 font-normal text-primary-200 text-sm">
                        Nunc mi ipsum faucibus vitae aliquet nec. Lacus sed viverra tellus in hac habitasse.
                    </h2>
                </header>
                <div>
                    <Button icon="pi pi-times" class="p-button-rounded p-button-text text-white-alpha-70 p-button-plain hover:bg-blue-500" pStyleClass="#slideover-11" leaveToClass="hidden" leaveActiveClass="fadeoutright" v-styleclass="{ selector: '#slideover-11', leaveToClass: 'hidden', leaveActiveClass: 'fadeoutright'}"></Button>
                </div>
            </div>
            <div class="px-4">
                <h3 class="text-base font-semibold mt-0 mb-0 text-color">Project Name</h3>
