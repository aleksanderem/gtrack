<template>
    <div>
        <div class="block-category-title">Dashboards</div>
                                    ...
                                    <div class="border-round p-4">
                                        ...
                                        <div class="mb-5 flex">
                                            ...
                                            <div class="ml-5 surface-card shadow-2 border-round p-3 flex-auto">
                                                ...
                                                <div class="line-height-3 text-700 mb-3">Eu tincidunt tortor aliquam nulla facilisi cras fermentum. Sollicitudin nibh sit amet commodo nulla. Mauris in aliquam sem fringilla ut morbi.</div>
                                        ...
                                        <div class="mb-5 flex">
                                            ...
                                            <div class="ml-5 surface-card shadow-2 border-round p-3 flex-auto">
                                                ...
                                                <div class="line-height-3 text-700 mb-3">
                                                    Purus sit amet volutpat consequat mauris. Pretium lectus quam id leo in vitae. Posuere sollicitudin aliquam ultrices sagittis orci a scelerisque purus semper.
                                                </div>
                                                <div class="text-500 flex align-items-center gap-4">
                                                    <div class="flex align-items-center gap-1">
                                                        <i class="pi pi-heart"></i>
                                        ...
                                        <div class="mb-5 flex">
                                            ...
                                            <div class="ml-5 surface-card shadow-2 border-round p-3 flex-auto">
                                                ...
                                                <div class="line-height-3 text-700 mb-3">Euismod in pellentesque massa placerat duis ultricies lacus. Vitae sapien pellentesque habitant morbi tristique senectus et netus et.</div>
                                                <div class="text-500 flex align-items-center gap-4">
                                                    <div class="flex align-items-center gap-1">
                                                        <i class="pi pi-heart"></i>
                                                        <span>62</span>
                                        ...
                                        <div class="flex align-items-start mr-0 lg:mr-5">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-700">
                                                    ...
                                                    <span class="text-900 font-medium">5</span> to <span class="text-900 font-medium">6</span>.
                                                </div>
                                            </div>
                                        </div>
