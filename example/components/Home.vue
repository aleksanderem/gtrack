<template>
    <div class="introduction">
        <div class="introduction-content shadow-2 relative overflow-hidden">
            <div class="introduction-title text-900">Vue UI Blocks</div>
            <div class="introduction-subtitle">Powered by PrimeVue</div>
            <p><strong>400+</strong> ready to use UI blocks to build spectacular applications in no time.</p>
            <div class="flex flex-nowrap flex-column align-items-center sm:flex-row sm:justify-content-center">
                <Button label="Browse All" @click="viewBlocks('#application')" class="w-full sm:w-auto font-bold p-3 mb-3 sm:mb-0 sm:mr-3"></Button>
                <router-link to="/free" custom v-slot="{ navigate }">
                    <Button label="Free Blocks" class="w-full sm:w-auto p-button-outlined font-bold p-3" @click="navigate"></Button>
                </router-link>
            </div>
            <div class="video-container mt-5 z-2 relative flex justify-content-center align-items-center">
                <iframe
                    width="420"
                    height="236"
                    src="https://www.youtube.com/embed/videoseries?list=PLC9bp-OHi-Wn0Vw2rJBMf6do08_H7PVd6"
                    title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
                    onload="this.classList.add('shadow-6')"
                ></iframe>
                <div class="introduction-gradient top-50 w-30rem h-20rem bg-primary absolute"></div>
            </div>
        </div>
    </div>
                ...
                <div class="grid">
                    <div class="col-12 md:col-3">
                        ...
                        <div class="flex align-items-start justify-content-between">
                            ...
                            <span class="badge-new">5 New</span>
                        </div>
                    </div>
                    <div class="col-12 md:col-3">
                    ...
                    <div class="col-12 md:col-3">
                        <router-link to="/application/commandmenu">
                            <img :src="$appState.dark ? 'images/placeholders/placeholder-commandmenu-dark.svg' : 'images/placeholders/placeholder-commandmenu.svg'" class="block-placeholder" alt="Notification" />
                        </router-link>
                        <div class="flex align-items-start justify-content-between">
                            <div>
                                <span class="block-name">Command Menu</span>
                                <span class="block-count">6 Blocks</span>
                            </div>
                            <span class="badge-new">6 New</span>
                        </div>
                    </div>
                </div>
            </div>
